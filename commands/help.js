...
module.exports = {
    ...
    async help(message){
        ...
        .addFields(
            ...
            { name: '***6: Repeat Command***', value: ':radio_button: ***repeat*** and ***restart*** Will repeat the current song'},
            { name: '***7: Loop Song Command***', value: ':radio_button: ***-loopsong*** or ***-ls*** Will ***Loop*** The Current ***Song***, To Disable ***Loop Song*** Enter The Command Again'},
            { name: '***8: Loop Queue Command***', value: ':radio_button: ***-loopsong*** or ***-ls*** Will ***Loop*** The Current ***Queue***, To Disable ***Loop Queue*** Enter The Command Again'},
            { name: '***9: Queue Command***', value: ':radio_button: ***-queue*** or ***-list*** Will ***List*** Out The ***Current Queue*** With An ***Assigned Number*** 1,2,3 etc...'},
            { name: '***10: Remove Command***', value: ':radio_button: ***-remove*** or ***-r*** Will ***Remove A Song*** In The ***Queue*** With A ***Specified Number*** From The Queue List. You ***Cannot Remove*** The ***Current Song*** From The Queue'},
            { name: '***11: Leave Command***', value: ':radio_button: ***-leave, -disconnect, -dc*** or ***-die*** Will Make Smoothy ***Leave The Voice Channel*** And ***Clear The Queue***'},
        )
